...
int main()
{
	...
	auto nbs8 = pgn::cShapeCalc<pgn::cBoxDistance>::Get(1, 1);
	auto nbs4 = pgn::cShapeCalc<pgn::cDiamondDistance>::Get(1, 1);


	// Try a single goal
	pgn::cSingleGoal sgoal(glm::ivec2(5, 6), normfunc);
	...
	pgn::cSingleGoal sgoal2(glm::ivec2(5, 5), normfunc);
	...
	pgn::cMultiGoal mgoal(mgoal_pts, normfunc);
